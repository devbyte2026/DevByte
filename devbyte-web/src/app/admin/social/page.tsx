    ...
    <main className="min-h-screen bg-surface-muted">
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-primary">Generador de Contenido Social</h1>
            <p className="text-sm text-text-muted">Crea posts para Facebook, Instagram y WhatsApp</p>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Card className="p-6 mb-6">
          <h3 className="text-lg font-semibold text-primary mb-4">Seleccionar tipo de contenido</h3>
          ...
          <Button onClick={handleGenerate} className="mt-6" size="lg" disabled={loading}>
        ...
        {generatedContent.length > 0 && (
          <div className="space-y-6">
            <Card className="p-6">
              ...
              <p className="text-sm text-text-muted whitespace-pre-wrap mb-4">{generatedContent[0]}</p>
              <Button variant="outline" size="sm" onClick={() => copyToClipboard(generatedContent[0], 0)}>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-text-muted whitespace-pre-wrap mb-4">{generatedContent[1]}</p>
              <Button variant="outline" size="sm" onClick={() => copyToClipboard(generatedContent[1], 1)}>
                <Copy size={16} className="mr-2" />
        ...
        <div className="mt-8 text-center text-text-muted text-sm">
          <p>Contenido generado como inspiración. Personalizá según necesidad.</p>
        </div>
      </div>
    </main>
  );
