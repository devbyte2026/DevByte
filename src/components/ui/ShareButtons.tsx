    ...
    <div className="flex items-center gap-2">
      {shareLinks.map((link) => (
        <a
          ...
          className="p-2 rounded-lg bg-surface-muted hover:bg-gray-200 transition-colors"
        >
          {link.icon}
        </a>
      ))}
