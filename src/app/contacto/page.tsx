...
export const metadata: Metadata = {
  ...
  description: "Contactá a DevByte para solicitar un presupuesto de desarrollo web. Estamos en Resistencia, Chaco — Atendemos todo el NEA.",
  keywords: ["contacto devbyte", "presupuesto web Resistencia", "agencia web Chaco"],
};
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-text-muted max-w-xl mx-auto text-lg">
            ¿Necesitás una web para tu negocio? Completá el formulario y te respondemos a la brevedad.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-text-muted text-sm">Resistencia, Chaco — NEA, Argentina</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hola@devbyte.com.ar" className="text-text-muted text-sm hover:text-accent">
                      hola@devbyte.com.ar
                    </a>
                  </div>
                </li>
            ...
            <Card className="p-6">
              <h3 className="text-lg font-semibold text-primary mb-2">Horario de atención</h3>
              <p className="text-text-muted text-sm">Lunes a Viernes: 9:00 - 18:00</p>
              <p className="text-text-muted text-sm">Sábado y Domingo: Cerrado</p>
            </Card>
          </div>
        </div>
      </div>
